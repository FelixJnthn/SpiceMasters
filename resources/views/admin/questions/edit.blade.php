...
<!-- Content Row -->
        <div class="card shadow">
            ...
            <div class="card-body">
                <!-- $question->id untuk edit id ke sekian -->
                <form action="{{ route('admin.questions.update', $question->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control"  name="difficulty_id" id="difficulty">
                            @foreach($difficulties as $id => $difficulty)
                            <!-- menampilkan id difficulty dari question yg disellect -->
                                <option {{ $id == $question->difficulty->id ? 'selected' : null }} value="{{ $id }}">{{ $difficulty }}</option>
                            @endforeach
                        </select>
                    </div>
